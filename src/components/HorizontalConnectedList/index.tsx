  ...
  return (
    <div className={cls(css.item, classes.listItem)}>
      <div className={cls(css.icon, classes.icon)}>
        <div className={cls(css.connector, classes.connector, !showLeftConnector && css.hide, css[`border-${leftConnectorBorder}`])} />
        <div>{item.icon}</div>
        <div className={cls(css.connector, classes.connector, !showRightConnector && css.hide, css[`border-${rightConnectorBorder}`])} />
      </div>
